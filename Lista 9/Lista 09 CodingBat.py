...
def squirrel_play(temp, is_summer):
  return temp >= 60 and ((temp <= 90) or (temp <= 100 and is_summer == True))
...
def pego_correndo(speed, is_birthday):
  if is_birthday == True:
    speed = speed - 5;
  return 2 if speed > 80 else 1 if speed >= 61 else 0 
...
def alarm_clock(day, vacation):
  return 'off' if day in (0, 6) and vacation == True else '10:00' if vacation == True or day in (0, 6) else '7:00'
